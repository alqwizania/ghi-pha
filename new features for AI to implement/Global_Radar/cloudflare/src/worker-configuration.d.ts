/* eslint-disable */
// Generated by Wrangler by running `wrangler types cloudflare/src/worker-configuration.d.ts` (hash: 9a62e5abdbd3a543dc2714c1bd59c2bc)
// Runtime types generated with workerd@1.20260521.1 2026-05-26 nodejs_compat
interface __BaseEnv_Env {
	ARTIFACTS: R2Bucket;
	DB: D1Database;
	SOURCE_SCAN_QUEUE: Queue;
	FINDING_PROCESS_QUEUE: Queue;
	DEAD_LETTER_QUEUE: Queue;
	ASSETS: Fetcher;
	ENVIRONMENT: "staging" | "production";
	PUBLIC_CACHE_SECONDS: "60" | "300";
	OPENROUTER_BASE_URL: "https://openrouter.ai/api/v1";
	OPENROUTER_MODEL: "openai/gpt-4o-mini";
	PROCESS_SOURCE_WORKFLOW: Workflow<Parameters<import("./index").ProcessSourceWorkflow['run']>[0]['payload']>;
	BROWSER?: Fetcher;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_CACHE_SECONDS" | "OPENROUTER_BASE_URL" | "OPENROUTER_MODEL">> {}
}
